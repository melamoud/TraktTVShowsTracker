...
| My Movies/Shows missing titles that are on Trakt | Reload the page (membership follows `last_activities`). If still wrong, **Refresh from Trakt**. Progress/calendar can lag the admin TTL (default 2 hours). |
