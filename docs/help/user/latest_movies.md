...
**Search titles in this list…** filters the loaded Latest cache (after your year / match / watched filters) by title. **More filters** adds a production-year range and multi-select genres. For Trakt-wide search, use nav **Search**.
