...
| **Added to a streaming service** | A **new** service brand starts carrying that title. Multiple brands for the same title share **one** alert card listing every vendor. If any of those is unread, the card stays unread. Channel/tier renames like “Paramount Plus Apple TV channel” after Premium do **not** re-alert |
