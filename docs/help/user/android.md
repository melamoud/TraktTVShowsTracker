...
The current app version is shown in the top bar and just above the bottom navigation bar. It bumps automatically with each release so you can quickly confirm you have the latest APK.
