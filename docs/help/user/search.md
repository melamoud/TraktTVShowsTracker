...
5. **Set lists…** / **Mark watched** / **Rate…** / **Favorite** / **Found on…** / **Hide recommendation** work the same as elsewhere; shows also link to **Progress**. Open a result for the **title page**; **← Back** there returns to this Search (browser **Back** does too).
