...
- **Android Search** adds an explicit Search action and distinguishes “type then search” from “no results”
- APK builds are copied to `\\echo\AudioBooks\_TMP\` (see `.cursor/rules/copy-apk.mdc`)
- Updated [Android help](help/user/android.md)
