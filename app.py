...
def create_app(config_object=Config):
    ...
    from services.local_time import format_local_date as _format_local_date
    app.add_template_filter(_format_local_date, name='local_date')
    ...
    try:
        ...
        if 'user_media_state' in tables:
            ...
            for col, ddl in (
                ...
                ('alerts_pinned',
                 'ALTER TABLE user_media_state ADD COLUMN alerts_pinned BOOLEAN DEFAULT 0 NOT NULL'),
                ('alerts_pinned_at',
                 'ALTER TABLE user_media_state ADD COLUMN alerts_pinned_at DATETIME'),
                ('rating',
